        ...
        <div className="fixed bottom-24 lg:bottom-24 right-6 z-50 w-[380px] max-w-[calc(100vw-32px)] h-[500px] max-h-[calc(100vh-140px)] bg-white rounded-2xl border border-slate-200/90 shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-bottom-5 duration-300">
          ...
          <div className="bg-[#efeae2] px-3 pb-2.5 flex space-x-1.5 overflow-x-auto shrink-0 scrollbar-thin select-none">
            {[
              ...
              { label: "🏢 My Projects", cmd: "my projects", autoSubmit: true },
              { label: "📍 Projects Kokapet", cmd: "my projects kokapet", autoSubmit: true },
              { label: "🏢 Projects Flats", cmd: "my projects flats", autoSubmit: true },
              { label: "🏢 All My Projects", cmd: "my projects all", autoSubmit: true },
              ...
              { label: "👍 RSVP Yes", cmd: "yes", autoSubmit: true },
              { label: "👎 RSVP No", cmd: "no", autoSubmit: true },
              { label: "🎟️ Enter Code", cmd: "SUN7089", autoSubmit: true }
            ].map((item, idx) => (
              <button
                key={idx}
                type="button"
